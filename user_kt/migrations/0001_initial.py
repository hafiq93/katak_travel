# Generated by Django 4.2 on 2024-10-21 02:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(blank=True, default='default.jpg', null=True, upload_to=user_kt.models.user_directory_path)),
                ('full_name', models.CharField(blank=True, max_length=500, null=True)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('phone', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('identity_type', models.CharField(blank=True, choices=[('Identication Number (I/C)', 'Identication Number (I/C)'), ('Passport Number', 'Passport Number')], max_length=200, null=True)),
                ('identity_image', models.FileField(blank=True, default='id.jpg', null=True, upload_to=user_kt.models.user_directory_path)),
